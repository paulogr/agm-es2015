...
(function (global, factory) {
    (typeof exports === 'undefined' ? 'undefined' : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs/Observable')) : typeof define === 'function' && define.amd ? define(['exports', '@angular/core', 'rxjs/Observable'], factory) : factory((global.ngmaps = global.ngmaps || {}, global.ngmaps.core = global.ngmaps.core || {}), global.ng.core, global.Rx);
})(undefined, function (exports, _angular_core, rxjs_Observable) {
    'use strict';
    ...
    CircleManager.decorators = [{ type: _angular_core.Injectable }];
    /** @nocollapse */
    ...
    MarkerManager.decorators = [{ type: _angular_core.Injectable }];
    /** @nocollapse */
    ...
    InfoWindowManager.decorators = [{ type: _angular_core.Injectable }];
    /** @nocollapse */
    InfoWindowManager.ctorParameters = function () {
        return [{ type: GoogleMapsAPIWrapper }, { type: _angular_core.NgZone }, { type: MarkerManager }];
    };
    ...
    PolygonManager.decorators = [{ type: _angular_core.Injectable }];
    /** @nocollapse */
    ...
    PolylineManager.decorators = [{ type: _angular_core.Injectable }];
    /** @nocollapse */
    ...
    KmlLayerManager.decorators = [{ type: _angular_core.Injectable }];
    /** @nocollapse */
    ...
    DataLayerManager.decorators = [{ type: _angular_core.Injectable }];
    /** @nocollapse */
    ...
    AgmMap.decorators = [{ type: _angular_core.Component, args: [{
            selector: 'agm-map',
            providers: [GoogleMapsAPIWrapper, MarkerManager, InfoWindowManager, CircleManager, PolylineManager, PolygonManager, KmlLayerManager, DataLayerManager],
            host: {
    ...
    AgmMap.ctorParameters = function () {
        return [{ type: _angular_core.ElementRef }, { type: GoogleMapsAPIWrapper }];
    };
    ...
    AgmCircle.decorators = [{ type: _angular_core.Directive, args: [{
            selector: 'agm-circle'
        }] }];
    /** @nocollapse */
    AgmCircle.ctorParameters = function () {
        return [{ type: CircleManager }];
    };
    ...
    AgmInfoWindow.decorators = [{ type: _angular_core.Component, args: [{
            selector: 'agm-info-window',
            template: "<div class='agm-info-window-content'>\n      <ng-content></ng-content>\n    </div>\n  "
        }] }];
    /** @nocollapse */
    AgmInfoWindow.ctorParameters = function () {
        return [{ type: InfoWindowManager }, { type: _angular_core.ElementRef }];
    };
    ...
    AgmKmlLayer.decorators = [{ type: _angular_core.Directive, args: [{
            selector: 'agm-kml-layer'
        }] }];
    /** @nocollapse */
    AgmKmlLayer.ctorParameters = function () {
        return [{ type: KmlLayerManager }];
    };
    ...
    var AgmDataLayer = function () {
        ...
        AgmDataLayer.prototype.ngOnChanges = function (changes) {
            ...
            AgmDataLayer._dataOptionsAttributes.forEach(function (k) {
                return dataOptions[k] = changes.hasOwnProperty(k) ? changes[k].currentValue : _this[k];
            });
    ...
    AgmDataLayer.decorators = [{ type: _angular_core.Directive, args: [{
            selector: 'agm-data-layer'
        }] }];
    /** @nocollapse */
    AgmDataLayer.ctorParameters = function () {
        return [{ type: DataLayerManager }];
    };
    ...
    AgmMarker.decorators = [{ type: _angular_core.Directive, args: [{
            selector: 'agm-marker'
        }] }];
    /** @nocollapse */
    ...
    AgmPolygon.decorators = [{ type: _angular_core.Directive, args: [{
            selector: 'agm-polygon'
        }] }];
    /** @nocollapse */
    AgmPolygon.ctorParameters = function () {
        return [{ type: PolygonManager }];
    };
    ...
    AgmPolylinePoint.decorators = [{ type: _angular_core.Directive, args: [{ selector: 'agm-polyline-point' }] }];
    /** @nocollapse */
    ...
    AgmPolyline.decorators = [{ type: _angular_core.Directive, args: [{
            selector: 'agm-polyline'
        }] }];
    /** @nocollapse */
    AgmPolyline.ctorParameters = function () {
        return [{ type: PolylineManager }];
    };
    ...
    LazyMapsAPILoader.decorators = [{ type: _angular_core.Injectable }];
    /** @nocollapse */
    LazyMapsAPILoader.ctorParameters = function () {
        return [{ type: undefined, decorators: [{ type: _angular_core.Inject, args: [LAZY_MAPS_API_CONFIG] }] }, { type: WindowRef }, { type: DocumentRef }];
    };
    ...
    function coreDirectives() {
        return [AgmMap, AgmMarker, AgmInfoWindow, AgmCircle, AgmPolygon, AgmPolyline, AgmPolylinePoint, AgmKmlLayer, AgmDataLayer];
    }
    /**
    ...
    var AgmCoreModule = function () {
        ...
        AgmCoreModule.forRoot = function (lazyMapsAPILoaderConfig) {
            return {
                ...
                providers: BROWSER_GLOBALS_PROVIDERS.concat([{ provide: MapsAPILoader, useClass: LazyMapsAPILoader }, { provide: LAZY_MAPS_API_CONFIG, useValue: lazyMapsAPILoaderConfig }])
            };
        };
        return AgmCoreModule;
    }();
    AgmCoreModule.decorators = [{ type: _angular_core.NgModule, args: [{ declarations: coreDirectives(), exports: coreDirectives() }] }];
    /** @nocollapse */
