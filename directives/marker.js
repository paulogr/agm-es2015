...
AgmMarker.decorators = [{ type: _core.Directive, args: [{
        selector: 'agm-marker'
    }] }];
/** @nocollapse */
AgmMarker.ctorParameters = function () {
    return [{ type: _markerManager2.MarkerManager }];
};
AgmMarker.propDecorators = {
    ...
    'draggable': [{ type: _core.Input, args: ['markerDraggable'] }],
    'iconUrl': [{ type: _core.Input }],
    'visible': [{ type: _core.Input }],
    'openInfoWindow': [{ type: _core.Input }],
    'opacity': [{ type: _core.Input }],
    'zIndex': [{ type: _core.Input }],
    'clickable': [{ type: _core.Input, args: ['markerClickable'] }],
    'markerClick': [{ type: _core.Output }],
    'dragEnd': [{ type: _core.Output }],
    'mouseOver': [{ type: _core.Output }],
    'mouseOut': [{ type: _core.Output }],
    'infoWindow': [{ type: _core.ContentChildren, args: [_infoWindow.AgmInfoWindow] }]
};
