...
AgmCircle.decorators = [{ type: _core.Directive, args: [{
        selector: 'agm-circle'
    }] }];
/** @nocollapse */
AgmCircle.ctorParameters = function () {
    return [{ type: _circleManager.CircleManager }];
};
AgmCircle.propDecorators = {
    'latitude': [{ type: _core.Input }],
    'longitude': [{ type: _core.Input }],
    'clickable': [{ type: _core.Input }],
    'draggable': [{ type: _core.Input, args: ['circleDraggable'] }],
    ...
    'strokePosition': [{ type: _core.Input }],
    'strokeWeight': [{ type: _core.Input }],
    'visible': [{ type: _core.Input }],
    'zIndex': [{ type: _core.Input }],
    'centerChange': [{ type: _core.Output }],
    'circleClick': [{ type: _core.Output }],
    'circleDblClick': [{ type: _core.Output }],
    'drag': [{ type: _core.Output }],
    'dragEnd': [{ type: _core.Output }],
    'dragStart': [{ type: _core.Output }],
    'mouseDown': [{ type: _core.Output }],
    'mouseMove': [{ type: _core.Output }],
    'mouseOut': [{ type: _core.Output }],
    'mouseOver': [{ type: _core.Output }],
    'mouseUp': [{ type: _core.Output }],
    'radiusChange': [{ type: _core.Output }],
    'rightClick': [{ type: _core.Output }]
};
