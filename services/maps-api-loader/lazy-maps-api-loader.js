...
exports.LazyMapsAPILoader = exports.LAZY_MAPS_API_CONFIG = exports.GoogleMapsScriptProtocol = undefined;
 ...
 */
var LAZY_MAPS_API_CONFIG = exports.LAZY_MAPS_API_CONFIG = new _core.InjectionToken('angular-google-maps LAZY_MAPS_API_CONFIG');
...
LazyMapsAPILoader.decorators = [{ type: _core.Injectable }];
/** @nocollapse */
LazyMapsAPILoader.ctorParameters = function () {
    return [{ type: undefined, decorators: [{ type: _core.Inject, args: [LAZY_MAPS_API_CONFIG] }] }, { type: _browserGlobals.WindowRef }, { type: _browserGlobals.DocumentRef }];
};
